...
//       if (this.liveMode) {
//         this.currentPage = 0;
//         this.displayedAnomalies =
//           this.anomalies.slice(0, this.pageSize);
//       }

//       this.loading = false;
//       this.error = null;
//       if (!this.discountChart && !this.typeChart) {
...
//     this.displayedAnomalies =
//       this.anomalies.slice(start, start + this.pageSize);
//   }
...
//   console.log('Discount ref:', this.discountChartRef?.nativeElement);  // Should not be undefined
//   console.log('Type ref:', this.typeChartRef?.nativeElement);
  
//   const dctx = this.discountChartRef?.nativeElement?.getContext('2d');
//   const tctx = this.typeChartRef?.nativeElement?.getContext('2d');

//   if (dctx && !this.discountChart) {
//     this.discountChart = new Chart(dctx, {
//       type: 'bar',
//       data: {
//         labels: ['0'],                 // 🔑 NOT EMPTY
//         datasets: [{
...
//   if (tctx && !this.typeChart) {
//     this.typeChart = new Chart(tctx, {
//       type: 'pie',
//       data: {
//         labels: ['Init'],              // 🔑 NOT EMPTY
//         datasets: [{
//           data: [1]
//         }]
//       },
...
//     this.discountChart.data.labels = Object.keys(discountMap);
//     this.discountChart.data.datasets[0].data =
//       Object.values(discountMap);
